...
def process_pull_request pull_request
  ...
  if flag
    client.create_status(pull_request['base']['repo']['full_name'], pull_request['head']['sha'], 'failure', description: "This pull request contains fixup! commit. Please rebase it before merge.", context: "fixup!")
  else
